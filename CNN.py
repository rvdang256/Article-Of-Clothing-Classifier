...
#All the different layers of the model
fashion_model = Sequential()
fashion_model.add(Input(shape=(28,28,1)))
...
fashion_model.compile(loss=keras.losses.categorical_crossentropy, optimizer=optimizer,metrics=['accuracy'])
...
fashion_train = fashion_model.fit(train_X, train_label, batch_size=batch_size,epochs=epochs,verbose=1,validation_data=(valid_X, valid_label), callbacks=my_callbacks)
